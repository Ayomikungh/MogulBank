...
BULK INSERT Client
FROM 'C:\Users\ayomi\Documents\Data Nexus\DE_DA_DS_Challenge\client_data.csv'
WITH (
    FIELDTERMINATOR = ',',  
    ROWTERMINATOR = '\n',    
    FIRSTROW = 2           
...
FROM 'C:\Users\ayomi\Documents\Data Nexus\DE_DA_DS_Challenge\campaign_data.csv'
WITH (
    FIELDTERMINATOR = ',',  
    ROWTERMINATOR = '\n',    
    FIRSTROW = 2           
...
FROM 'C:\Users\ayomi\Documents\Data Nexus\DE_DA_DS_Challenge\economics_data.csv'
WITH (
    FIELDTERMINATOR = ',',  
    ROWTERMINATOR = '\n',    
    FIRSTROW = 2           
